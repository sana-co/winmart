  ...
  return (
    <a href="https://www.facebook.com/winmart.horana" target="_blank" rel="noopener noreferrer">
      <svg width="44" height="44" fill="none" viewBox="0 0 44 44">
        <rect width="44" height="44" rx="12" fill="#e30b43" />
  ...
  return (
    <footer className="w-full bg-white">
      <div className="mx-auto max-w-[1400px] px-4 py-10 sm:px-6 sm:py-14 lg:px-12">
        <div className="flex flex-col justify-between gap-10 lg:flex-row lg:gap-12">
          ...
          <div className="grid flex-1 grid-cols-1 gap-x-6 gap-y-8 text-center min-[430px]:grid-cols-2 min-[430px]:text-left lg:gap-10 xl:grid-cols-4 xl:gap-16">
            <div className="flex flex-col gap-3">
              <p className="text-[#1d285f]" style={{ fontFamily: "Roboto, sans-serif", fontWeight: 700, fontSize: "18px", letterSpacing: "0.3px" }}>
                Company
              </p>
              <Link to="/our-story" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
                About
              </Link>
              <Link to="/careers" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
                Careers
              </Link>
              <Link to="/feedback" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
                Contact Us
              </Link>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed"
                style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}
              >
                Find Our Store
              </a>
              <a href="#faqs" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
                FAQs
              </a>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="tel:+94777009697" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
                077 700 9697
              </a>
              <a href="mailto:winmartfashion.social@gmail.com" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed break-words" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
            ...
            <div className="flex flex-col gap-3">
              ...
              {["Terms & Conditions", "Privacy Policy"].map(link => (
                <a key={link} href="#" className="text-[#4f5874] hover:text-[#e30b43] transition-colors leading-relaxed" style={{ fontFamily: "Roboto, sans-serif", fontSize: "15px" }}>
                  {link}
                </a>
              ))}
            </div>
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-3 border-t border-[#1d285f]/15 pt-6 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-2">
            <span className="w-2 h-2 rounded-full bg-[#273777]" />
            <span className="w-2 h-2 rounded-full bg-[#e30b43]" />
            <span className="w-2 h-2 rounded-full bg-[#1d285f]/30" />
          </div>
        </div>
      </div>
    </footer>
