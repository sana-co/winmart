      ...
      >
        <div className="mx-auto flex max-w-[1100px] flex-col items-center gap-8 text-center sm:gap-12 lg:flex-row lg:text-left">
          <div className="min-w-0 flex-1">
            <span
              className="mb-5 inline-block rounded-full bg-[#D9043D] px-4 py-1 uppercase tracking-widest text-white"
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {openRoles.map((role) => (
              <div key={role.title} className="overflow-hidden rounded-[10px] border border-gray-100 bg-[#f7f7f7] shadow-sm sm:rounded-[20px]">
                <div className="flex flex-col justify-between gap-4 bg-[#253A8F] px-5 py-5 text-center sm:px-6 sm:text-left">
                  <div>
                    ...
                    <ul className="flex flex-col gap-2.5">
                      {role.requirements.map((req) => (
                        <li key={req} className="flex items-start gap-2.5">
                          <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#253A8F]/10">
                    ...
                    <ul className="flex flex-col gap-2.5">
                      {role.perks.map((perk) => (
                        <li key={perk} className="flex items-start gap-2.5">
                          <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#D9043D]/10">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {whyJoin.map((w) => (
              <div key={w.title} className="group mx-auto w-full max-w-[500px] rounded-[10px] border border-gray-100 bg-white p-5 shadow-sm transition-shadow hover:shadow-md sm:max-w-none sm:rounded-[20px] sm:p-7">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#253A8F]/10 text-[#253A8F] transition-colors group-hover:bg-[#253A8F] group-hover:text-white">
                  {w.icon}
                </div>
        ...
        <div className="mx-auto max-w-[860px]">
          ...
          {submitted ? (
            <div className="rounded-[10px] border border-gray-100 bg-[#f7f7f7] p-6 text-center sm:rounded-[24px] sm:p-12">
              <CheckCircle size={52} className="mx-auto mb-4 text-[#253A8F]" />
            ...
            <form onSubmit={handleSubmit} className="rounded-[10px] border border-gray-100 bg-[#f7f7f7] p-5 sm:rounded-[24px] sm:p-8 lg:p-10">
              <div className="mb-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
                {[
                  ...
                  <div key={f.id} className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      required={f.required}
                      className="rounded-[10px] border border-gray-200 bg-white px-4 py-3 text-[#191919] outline-none transition-all placeholder:text-gray-400 focus:border-[#253A8F]"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[#191919]" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 500, fontSize: "13px" }}>
                    Position Applying For <span className="text-[#D9043D]">*</span>
                  </label>
                  <select
                    value={form.role}
                    onChange={(e) => set("role", e.target.value)}
                    className="cursor-pointer appearance-none rounded-[10px] border border-gray-200 bg-white px-4 py-3 text-[#191919] outline-none transition-all focus:border-[#253A8F]"
                    style={{ fontFamily: "Poppins, sans-serif", fontSize: "14px" }}
                    required
                  >
              ...
              <div className="mb-5 flex flex-col gap-1.5">
                <label className="text-[#191919]" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 500, fontSize: "13px" }}>
                  Upload CV <span className="text-[#D9043D]">*</span>
                </label>
                <label className="relative flex cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden rounded-[10px] border border-dashed border-[#253A8F]/40 bg-white px-4 py-5 text-center transition-colors hover:border-[#253A8F]">
                  <Upload size={22} className="text-[#253A8F]" />
              ...
              <div className="mb-7 flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="resize-none rounded-[10px] border border-gray-200 bg-white px-4 py-3 text-[#191919] outline-none transition-all placeholder:text-gray-400 focus:border-[#253A8F]"
                  style={{ fontFamily: "Poppins, sans-serif", fontSize: "14px" }}
                />
              </div>
              ...
              <div className="flex flex-col items-stretch gap-4 min-[430px]:flex-row min-[430px]:items-center min-[430px]:justify-between">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="min-h-11 rounded-[8px] bg-[#D9043D] px-6 py-3.5 text-white shadow-md transition-all hover:bg-[#b8032f] active:scale-95 disabled:cursor-not-allowed disabled:opacity-70 sm:rounded-[10px] sm:px-10"
                  style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "16px" }}
                >
